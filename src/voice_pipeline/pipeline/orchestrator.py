...
class PipelineOrchestrator:
    ...
    def __init__(
        ...
        self._transcriber: WhisperLocalTranscriber | None = None
        self._extractor: IntentExtractor | None = None
        self._jira: AsyncJiraClient | None = None

    def _get_transcriber(self) -> WhisperLocalTranscriber:
    ...
    async def _execute_from_text(self, text: str) -> PipelineResult | ClarificationNeeded:
        ...
        return await self._create_ticket(intent, text)
    ...
    async def _execute_clarification(
        ...
        return await self._create_ticket(intent, combined_text)

    async def _create_ticket(self, intent: JiraTicketIntent, text: str) -> PipelineResult:
